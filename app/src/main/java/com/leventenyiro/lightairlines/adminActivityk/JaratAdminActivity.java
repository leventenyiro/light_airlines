...
public class JaratAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jarat_admin);
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JaratAdminActivity.this, JaratInsertActivity.class);
    ...
    private void init() {
        ...
        alertDialogBuilder = new AlertDialog.Builder(JaratAdminActivity.this);
        ...
        alertDialogBuilder.setNegativeButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(JaratAdminActivity.this, LoginActivity.class);
                startActivity(intent);
                finish();
